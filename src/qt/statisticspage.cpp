...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "Mining reward currently is 5 AOP per block";
    }
	else if (pindexBest->nHeight <= 262800)
    {
        subsidy = "Mining reward currently is 10 AOP per block";
    }
	else if (pindexBest->nHeight <= 525600)
    {
        subsidy = "Mining reward currently is 15 AOP per block";
    }
	else if (pindexBest->nHeight <= 1314000)
    {
        subsidy = "Mining reward currently is 10 AOP per block";
