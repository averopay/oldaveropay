...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	else if (pindexBest->nHeight <= 3601)
                nSubsidy = 5 * COIN;
...
const int YEARLY_BLOCKCOUNT = 262800; // Amount of Blocks per year
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    nRewardCoinYear = COIN_YEAR_REWARD; // 0.2 20%
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "AveroPay for the future!";
        CTransaction txNew;
        txNew.nTime = 1530616999;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nTime    = 1530616999;
        block.nVersion = 1;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
		block.nNonce   = 41660;
		if(fTestNet)
        {
            block.nNonce   = 2831442;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe025c171662007aa3e74f5fd68518324367ff0e2f36a32ee73c50fae11b4a90f"));
        block.print();
